...
public class JSONUtil extends JSON {
	...
	public void put(String key, final Object object, final boolean keeped, final String... propertyNames) {
		this.map.put(key, toJSON(object, keeped, propertyNames));
	}
	 ...
	 * 
	 * <br><br>作者： caoyu
	 * <br>时间： 2015年6月8日 下午6:36:31
	 * @param key			节点名
	 * @param object		节点对应的数据
	 */
	public void put(String key, final Object object) {
		this.map.put(key, toJSON(object));
	}
	 ...
	 *
	 * <br><br>作者： caoyu
	 * <br>时间： 2015年6月8日 下午6:53:22
	 * @return	返回格式完毕的json数据
	 */
	@Override
