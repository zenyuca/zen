...
public class JSONData<T> {
	 ...
	 *
	 * <br><br>作者： caoyu
	 * <br>时间： 2015年6月9日 上午9:48:48
	 * @return 对象的全息字符串描述。
	 */
	@Override
	public String toString() {
		return "JSONData [data=" + data + ", state=" + state + ", massage="
				+ message + "]";
	}
